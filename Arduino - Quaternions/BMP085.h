...
public:
    ...
    // BMP Sensors
    int32_t read_pressure();                // pressure in Pa + offset
    int32_t read_altitude();       // altitude in centimeters + offset
    int32_t read_temp();    // temperature in C�
